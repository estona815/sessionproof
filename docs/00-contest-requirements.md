...
Verified: 2026-07-22T01:38:18+09:00 (Asia/Seoul)

Primary sources: [official page](https://xprize.devpost.com/), [official rules](https://xprize.devpost.com/rules), [official FAQ](https://xprize.devpost.com/details/faq).
...
| Gemini                 | Any project with LLM functionality must make at least one Gemini API call in the deployed app                                                 | Production adapter exists; live deployed call unverified                                      |
| Functionality          | Demonstrate/explain how AI transforms business workflows                                                                                      | Demo and narrative drafted; fixture is not production evidence                                |
| Real business          | Launch during the hackathon, acquire real users, and generate real revenue                                                                    | Not achieved or evidenced                                                                     |
| Revenue disclosure     | Arms-length third-party total in USD; May–Aug monthly revenue; related-party separately                                                       | Templates exist; verified values are zero                                                     |
| Cost disclosure        | Total costs excluding marketing; marketing/customer acquisition separately even if zero                                                       | Templates exist; verified values are zero                                                     |
...
| Language               | English, or English translations for all submission materials                                                                                 | Product/submission drafts are English                                                         |
| Multiple submissions   | Allowed, but each must be unique and substantially different                                                                                  | Workspace projects differ in topic/output; entrant must disclose any other XPRIZE submissions |
| Judging                | Equal weight: Business Viability, AI-Native Operations, Category Impact                                                                       | Business evidence is currently the largest weakness                                           |
| Awards                 | $500k first, $200k second, $100k third–fifth, 15×$50k runners-up, five $50k category prizes                                                   | One project can win at most one prize                                                         |
